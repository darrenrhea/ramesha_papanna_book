...
def html_page_context(app, pagename, templatename, context, doctree):
    ...
    # For sphinx_rtd_theme.  https://gist.github.com/MantasVaitkunas/7c16de233812adcb7028#file-edit_on_github-py-L38-L43
    ...
    context['source_suffix'] = list(app.config.source_suffix)[0]
